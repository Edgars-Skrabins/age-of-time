...
namespace Dan.Main
{
    public class LeaderboardReference
    {
        ...
        public LeaderboardReference(string publicKey)
        {
            PublicKey = publicKey;
        }
        ...
        public void ResetPlayer(Action onReset = null)
        {
            LeaderboardCreator.ResetPlayer(onReset);
        }
    }
}